...
m_w(w), m_h(h),
m_startIrisRadius(50), m_endIrisRadius(180), m_levels(3),f_levels(2), // m_levels is 3 radii are not divided by two
m_startPupilRadius(12), m_endPupilRadius(48),  //radii are not divided by two
...
//m_minIrisAngle((float) (-90*CV_PI/180) ), m_maxIrisAngle((float) (60*CV_PI/180) ), // -90  to 60
...
{
	//printf("inside Process: minPupilAngle = %d, MaxPupilAngle = %d", (int)m_minPupilAngle*180/CV_PI, (int)m_maxPupilAngle*180/CV_PI);
#ifdef FINDIRIS
