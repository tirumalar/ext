...
#define EPPI0_CONTROL
/*
** ioctl commands
*/

#define CMD_SETUP_VIDEO_STREAM 50
#define CMD_TEARDOWN_VIDEO_STREAM 51
#define CMD_READFRAME_VIDEO_STREAM 52
#define CMD_SET_PIXEL_PER_LINE 53
#define CMD_SET_LINES_PER_FRAME 54
...
struct frameRead{
	unsigned short isBlocking;
	unsigned short isLatest;
	unsigned long minIdx;
	unsigned long start_addr;
	unsigned long actualIdx;
};
