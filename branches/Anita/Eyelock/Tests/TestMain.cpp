...
int main(int count, char *strings[]){
	...
	if(count<=1) {
		...
		if(false){
			...
			ignored.add("NWMatchMgrDualEye","Madhav","29092014","NWMatchMgrDualEye Test Commented");
			ignored.add("NWMatchMgrUniEye","Madhav","29092014","NWMatchMgrUniEye Test Commented");
