...
extern "C" void compute_LUT_sqrtminmax_C(unsigned short *SQRT_LUT_0_64, unsigned short *SQRT_LUT_0_256,int gradientpupilmin,int gradientpupilmax,int gradientcirclemin,int gradientcirclemax);
