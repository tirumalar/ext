...
/* `#END` */
    ...
    *******************************************************************************/
    CY_ISR(UART_ACS_RXISR)
    {
    ...
    #ifdef UART_ACS_RXISR_ENTRY_CALLBACK
        UART_ACS_RXISR_EntryCallback();
    #endif /* UART_ACS_RXISR_ENTRY_CALLBACK */
        ...
        do
        {
            ...
            */
            ...
            #ifdef UART_ACS_RXISR_ERROR_CALLBACK
                UART_ACS_RXISR_ERROR_Callback();
            #endif /* UART_ACS_RXISR_ERROR_CALLBACK */
            }
    ...
    #ifdef UART_ACS_RXISR_EXIT_CALLBACK
        UART_ACS_RXISR_ExitCallback();
    #endif /* UART_ACS_RXISR_EXIT_CALLBACK */
    ...
    *******************************************************************************/
    ...
    #ifdef UART_ACS_TXISR_ENTRY_CALLBACK
        UART_ACS_TXISR_EntryCallback();
    #endif /* UART_ACS_TXISR_ENTRY_CALLBACK */
    ...
    #ifdef UART_ACS_TXISR_EXIT_CALLBACK
        UART_ACS_TXISR_ExitCallback();
    #endif /* UART_ACS_TXISR_EXIT_CALLBACK */
