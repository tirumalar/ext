...
/*******************************************************************************
* Function Name: clock_2kHz_Start
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void clock_2kHz_Start(void) 
{
    /* Set the bit to enable the clock. */
    clock_2kHz_CLKEN |= clock_2kHz_CLKEN_MASK;
	clock_2kHz_CLKSTBY |= clock_2kHz_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: clock_2kHz_Stop
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void clock_2kHz_Stop(void) 
{
    /* Clear the bit to disable the clock. */
    clock_2kHz_CLKEN &= (uint8)(~clock_2kHz_CLKEN_MASK);
	clock_2kHz_CLKSTBY &= (uint8)(~clock_2kHz_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: clock_2kHz_StopBlock
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void clock_2kHz_StopBlock(void) 
{
    if ((clock_2kHz_CLKEN & clock_2kHz_CLKEN_MASK) != 0u)
    {
...
#if defined(clock_2kHz__CFG3)
        CLK_DIST_AMASK = clock_2kHz_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = clock_2kHz_CLKEN_MASK;
        CLK_DIST_AMASK = 0x00u;
#endif /* clock_2kHz__CFG3 */

        /* Clear mask of bus clock. */
        CLK_DIST_BCFG2 &= (uint8)(~BCFG2_MASK);

        oldDivider = CY_GET_REG16(clock_2kHz_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(clock_2kHz_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: clock_2kHz_StandbyPower
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void clock_2kHz_StandbyPower(uint8 state) 
{
    if(state == 0u)
    {
        clock_2kHz_CLKSTBY &= (uint8)(~clock_2kHz_CLKSTBY_MASK);
...
/*******************************************************************************
* Function Name: clock_2kHz_SetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void clock_2kHz_SetDividerRegister(unsigned short clkDivider, uint8 restart)
                                
{
    uint8 enabled;

    uint8 currSrc = clock_2kHz_GetSourceRegister();
    unsigned short oldDivider = clock_2kHz_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = clock_2kHz_CLKEN & clock_2kHz_CLKEN_MASK;
        ...
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((clock_2kHz_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
...
/*******************************************************************************
* Function Name: clock_2kHz_GetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
unsigned short clock_2kHz_GetDividerRegister(void) 
{
    return CY_GET_REG16(clock_2kHz_DIV_PTR);
}


/*******************************************************************************
* Function Name: clock_2kHz_SetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void clock_2kHz_SetModeRegister(uint8 modeBitMask) 
{
    clock_2kHz_MOD_SRC |= modeBitMask & (uint8)clock_2kHz_MODE_MASK;
}


/*******************************************************************************
* Function Name: clock_2kHz_ClearModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void clock_2kHz_ClearModeRegister(uint8 modeBitMask) 
{
    clock_2kHz_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(clock_2kHz_MODE_MASK));
}


/*******************************************************************************
* Function Name: clock_2kHz_GetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 clock_2kHz_GetModeRegister(void) 
{
    return clock_2kHz_MOD_SRC & (uint8)(clock_2kHz_MODE_MASK);
}


/*******************************************************************************
* Function Name: clock_2kHz_SetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void clock_2kHz_SetSourceRegister(uint8 clkSource) 
{
    unsigned short currDiv = clock_2kHz_GetDividerRegister();
    uint8 oldSrc = clock_2kHz_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        clock_2kHz_MOD_SRC |= CYCLK_SSS;
        clock_2kHz_MOD_SRC =
            (clock_2kHz_MOD_SRC & (uint8)(~clock_2kHz_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: clock_2kHz_GetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 clock_2kHz_GetSourceRegister(void) 
{
    return clock_2kHz_MOD_SRC & clock_2kHz_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: clock_2kHz_SetPhaseRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void clock_2kHz_SetPhaseRegister(uint8 clkPhase) 
{
    clock_2kHz_PHASE = clkPhase & clock_2kHz_PHASE_MASK;
}


/*******************************************************************************
* Function Name: clock_2kHz_GetPhase
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 clock_2kHz_GetPhaseRegister(void) 
{
    return clock_2kHz_PHASE & clock_2kHz_PHASE_MASK;
}
