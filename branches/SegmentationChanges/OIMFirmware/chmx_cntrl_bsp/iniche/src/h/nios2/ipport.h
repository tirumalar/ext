...
/* task stack sizes */
#define  NET_STACK_SIZE       (4096+8192*2)
#define  APP_STACK_SIZE       (6144+8192*2) /* 4096 */     /* default for applications */
 ...
 */
#define NUMBIGBUFS   40
#define NUMLILBUFS   40

/* some maximum packet buffer numbers */
#define MAXBIGPKTS   40
#define MAXLILPKTS   40
