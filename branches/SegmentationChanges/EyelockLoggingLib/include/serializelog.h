...
{
public:
	// For each class we want to serialize, we need to derive from I and write the code to do the serialization...
    class I
    {
    public:
    ...
    {
    	return false;
    	//DMO we always write out in Big Endian for ISO...
    ...
    }else
    {
      ...
      if(std::is_trivial<T>::value)
           return  read_internal(istream_, (char*)&t_, sizeof(t_));
             ...
             return  read(istream_, (serializelog::I*)&t_);
    }
    assert(0);
    return istream_;
}
    ...
    }else
    {
        ...
        if(std::is_trivial<T>::value)
           return write_internal(ostream_, (const char*)&t_, sizeof(t_));
            ...
            return write(ostream_, (serializelog::I*)&t_);
    }
