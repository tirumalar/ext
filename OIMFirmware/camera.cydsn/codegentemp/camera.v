// ======================================================================
// camera.v generated from TopDesign.cysch
// 11/12/2018 at 09:30
...
// IDAC_P4_v1_10(IDACRange=1, IDACValue=0, Polarity=0, Resolution=8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=IDAC_P4_v1_10, CY_CONFIG_TITLE=IDAC_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=IDAC_1, CY_INSTANCE_SHORT_NAME=IDAC_1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=IDAC_1, )
...
// OpAmp_P4_v1_20(Compensation=3, DeepSleepSupport=false, Mode=1, OutputCurrent=1, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=OpAmp_P4_v1_20, CY_CONFIG_TITLE=Opamp_FACE, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Opamp_FACE, CY_INSTANCE_SHORT_NAME=Opamp_FACE, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=20, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Opamp_FACE, )
module OpAmp_P4_v1_20_1 (
    Vplus,
    Vout,
    Vminus);
    inout       Vplus;
...
module ADC_SAR_SEQ_P4_v2_50_2 (
	...
	cy_clock_v1_0
		#(.id("21f2d42a-a31b-42f6-9ccd-e3053466cf4f/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
...
// TCPWM_P4_v2_10(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=1, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=440, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadAutoStart=true, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=false, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=1, TCPeriod=65535, TCPrescaler=0, TCPWMCapturePresent=false, TCPWMConfig=7, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=false, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=false, TermVisibility_interrupt=true, TermVisibility_line=true, TermVisibility_line_n=true, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=false, TermVisibility_stop=false, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_P4_v2_10, CY_CONFIG_TITLE=PWM_CHARGE, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_CHARGE, CY_INSTANCE_SHORT_NAME=PWM_CHARGE, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=PWM_CHARGE, )
...
// OpAmp_P4_v1_20(Compensation=3, DeepSleepSupport=false, Mode=1, OutputCurrent=1, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=OpAmp_P4_v1_20, CY_CONFIG_TITLE=Opamp_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Opamp_1, CY_INSTANCE_SHORT_NAME=Opamp_1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=20, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Opamp_1, )
...
// OpAmp_P4_v1_20(Compensation=3, DeepSleepSupport=false, Mode=1, OutputCurrent=1, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=OpAmp_P4_v1_20, CY_CONFIG_TITLE=Opamp_2, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Opamp_2, CY_INSTANCE_SHORT_NAME=Opamp_2, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=20, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Opamp_2, )
...
// IDAC_P4_v1_10(IDACRange=1, IDACValue=0, Polarity=0, Resolution=8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=IDAC_P4_v1_10, CY_CONFIG_TITLE=IDAC_2, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=IDAC_2, CY_INSTANCE_SHORT_NAME=IDAC_2, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=IDAC_2, )
module IDAC_P4_v1_10_7 (
    Iout);
    inout       Iout;
    electrical  Iout;
...
module top ;
	...
	wire [0:0] tmpOE__RESIST_net;
	wire [0:0] tmpFB_0__RESIST_net;
	wire [0:0] tmpIO_0__RESIST_net;
	wire [0:0] tmpINTERRUPT_0__RESIST_net;
	electrical [0:0] tmpSIOVREF__RESIST_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		RESIST
		 (.oe(tmpOE__RESIST_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RESIST_net[0:0]}),
		  .analog({Net_3053}),
		  .io({tmpIO_0__RESIST_net[0:0]}),
		  .siovref(tmpSIOVREF__RESIST_net),
		  .interrupt({tmpINTERRUPT_0__RESIST_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RESIST_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    OpAmp_P4_v1_20_1 Opamp_FACE (
        .Vplus(Net_3053),
        .Vout(Net_3059),
        .Vminus(Net_85));

	wire [0:0] tmpOE__VFB_net;
	wire [0:0] tmpFB_0__VFB_net;
	wire [0:0] tmpIO_0__VFB_net;
	wire [0:0] tmpINTERRUPT_0__VFB_net;
	electrical [0:0] tmpSIOVREF__VFB_net;

	cy_psoc3_pins_v1_10
		#(.id("85fe8279-2289-4fd4-91ba-56a738ed80a8"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		VFB
		 (.oe(tmpOE__VFB_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VFB_net[0:0]}),
		  .analog({Net_239}),
		  .io({tmpIO_0__VFB_net[0:0]}),
		  .siovref(tmpSIOVREF__VFB_net),
		  .interrupt({tmpINTERRUPT_0__VFB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VFB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [7:0] tmpOE__PWM_net;
	wire [7:0] tmpFB_7__PWM_net;
	wire [7:0] tmpIO_7__PWM_net;
	wire [0:0] tmpINTERRUPT_0__PWM_net;
	electrical [0:0] tmpSIOVREF__PWM_net;
	...
	cy_psoc3_pins_v1_10
		...
		PWM
		 (.oe(tmpOE__PWM_net),
		  .y({Net_145, Net_145, Net_145, Net_145, Net_145, Net_145, Net_145, Net_145}),
		  .fb({tmpFB_7__PWM_net[7:0]}),
		  .io({tmpIO_7__PWM_net[7:0]}),
		  .siovref(tmpSIOVREF__PWM_net),
		  .interrupt({tmpINTERRUPT_0__PWM_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWM_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{8'b11111111} : {8'b11111111};


	cy_clock_v1_0
		#(.id("181787db-c75e-40ea-8012-56cc915e7bf1"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_clock_v1_0
		#(.id("1fb4a6b0-e005-4945-8c4e-a7ea286e5377"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__EN_A_net;
	wire [0:0] tmpFB_0__EN_A_net;
	wire [0:0] tmpIO_0__EN_A_net;
	wire [0:0] tmpINTERRUPT_0__EN_A_net;
	electrical [0:0] tmpSIOVREF__EN_A_net;

	cy_psoc3_pins_v1_10
		#(.id("df058039-378c-45c3-a607-5b80bbf7b9c2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		EN_A
		 (.oe(tmpOE__EN_A_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__EN_A_net[0:0]}),
		  .io({tmpIO_0__EN_A_net[0:0]}),
		  .siovref(tmpSIOVREF__EN_A_net),
		  .interrupt({tmpINTERRUPT_0__EN_A_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__EN_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__EN_B_net;
	wire [0:0] tmpFB_0__EN_B_net;
	wire [0:0] tmpIO_0__EN_B_net;
	wire [0:0] tmpINTERRUPT_0__EN_B_net;
	electrical [0:0] tmpSIOVREF__EN_B_net;

	cy_psoc3_pins_v1_10
		#(.id("be49f4eb-4538-4c60-aa11-36a9f853df65"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		EN_B
		 (.oe(tmpOE__EN_B_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__EN_B_net[0:0]}),
		  .io({tmpIO_0__EN_B_net[0:0]}),
		  .siovref(tmpSIOVREF__EN_B_net),
		  .interrupt({tmpINTERRUPT_0__EN_B_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__EN_B_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__VREF_A_net;
	wire [0:0] tmpFB_0__VREF_A_net;
	wire [0:0] tmpIO_0__VREF_A_net;
	wire [0:0] tmpINTERRUPT_0__VREF_A_net;
	electrical [0:0] tmpSIOVREF__VREF_A_net;

	cy_psoc3_pins_v1_10
		#(.id("a591a0c0-4ffd-43d5-ad90-def21845ebca"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		VREF_A
		 (.oe(tmpOE__VREF_A_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VREF_A_net[0:0]}),
		  .analog({Net_3034}),
		  .io({tmpIO_0__VREF_A_net[0:0]}),
		  .siovref(tmpSIOVREF__VREF_A_net),
		  .interrupt({tmpINTERRUPT_0__VREF_A_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VREF_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__VREF_B_net;
	wire [0:0] tmpFB_0__VREF_B_net;
	wire [0:0] tmpIO_0__VREF_B_net;
	wire [0:0] tmpINTERRUPT_0__VREF_B_net;
	electrical [0:0] tmpSIOVREF__VREF_B_net;

	cy_psoc3_pins_v1_10
		#(.id("64379ecf-fa74-4a5c-83d1-4bafac0eebb9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		VREF_B
		 (.oe(tmpOE__VREF_B_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VREF_B_net[0:0]}),
		  .analog({Net_3045}),
		  .io({tmpIO_0__VREF_B_net[0:0]}),
		  .siovref(tmpSIOVREF__VREF_B_net),
		  .interrupt({tmpINTERRUPT_0__VREF_B_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VREF_B_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    OpAmp_P4_v1_20_6 Opamp_2 (
        .Vplus(Net_3053),
        .Vout(Net_3045),
        .Vminus(Net_30));
	...
	wire [0:0] tmpOE__TRIG_LEFT_net;
	wire [0:0] tmpIO_0__TRIG_LEFT_net;
	wire [0:0] tmpINTERRUPT_0__TRIG_LEFT_net;
	electrical [0:0] tmpSIOVREF__TRIG_LEFT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		TRIG_LEFT
		 (.oe(tmpOE__TRIG_LEFT_net),
		  .y({1'b0}),
		  .fb({Net_131}),
		  .io({tmpIO_0__TRIG_LEFT_net[0:0]}),
		  .siovref(tmpSIOVREF__TRIG_LEFT_net),
		  .interrupt({tmpINTERRUPT_0__TRIG_LEFT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TRIG_LEFT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__TRIG_FACE_net;
	wire [0:0] tmpIO_0__TRIG_FACE_net;
	wire [0:0] tmpINTERRUPT_0__TRIG_FACE_net;
	electrical [0:0] tmpSIOVREF__TRIG_FACE_net;

	cy_psoc3_pins_v1_10
		#(.id("bc307577-0a92-412c-951f-b254a3b738ef"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		TRIG_FACE
		 (.oe(tmpOE__TRIG_FACE_net),
		  .y({1'b0}),
		  .fb({Net_141}),
		  .io({tmpIO_0__TRIG_FACE_net[0:0]}),
		  .siovref(tmpSIOVREF__TRIG_FACE_net),
		  .interrupt({tmpINTERRUPT_0__TRIG_FACE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TRIG_FACE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__TRIG_RIGHT_net;
	wire [0:0] tmpIO_0__TRIG_RIGHT_net;
	wire [0:0] tmpINTERRUPT_0__TRIG_RIGHT_net;
	electrical [0:0] tmpSIOVREF__TRIG_RIGHT_net;

	cy_psoc3_pins_v1_10
		#(.id("555f2d10-c6c7-49bb-ab76-a59038c809b5"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		TRIG_RIGHT
		 (.oe(tmpOE__TRIG_RIGHT_net),
		  .y({1'b0}),
		  .fb({Net_138}),
		  .io({tmpIO_0__TRIG_RIGHT_net[0:0]}),
		  .siovref(tmpSIOVREF__TRIG_RIGHT_net),
		  .interrupt({tmpINTERRUPT_0__TRIG_RIGHT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TRIG_RIGHT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    assign Net_3003 = Net_141 & Net_142;


    assign Net_130 = Net_138 & Net_139;


    assign Net_133 = Net_131 & Net_122;

    CyControlReg_v1_80 Control_Trig (
        .control_1(Net_139),
        .control_2(Net_142),
        .control_3(Net_121),
        .control_0(Net_122),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Control_Trig.Bit0Mode = 0;
    defparam Control_Trig.Bit1Mode = 0;
    defparam Control_Trig.Bit2Mode = 0;
    defparam Control_Trig.Bit3Mode = 0;
    defparam Control_Trig.Bit4Mode = 0;
    defparam Control_Trig.Bit5Mode = 0;
    defparam Control_Trig.Bit6Mode = 0;
    defparam Control_Trig.Bit7Mode = 0;
    defparam Control_Trig.BitValue = 0;
    defparam Control_Trig.BusDisplay = 0;
    defparam Control_Trig.ExtrReset = 0;
    defparam Control_Trig.NumOutputs = 3;


    assign Net_124 = Net_133 | Net_130 | Net_3003;

    IDAC_P4_v1_10_7 IDAC_2 (
        .Iout(Net_3053));

	wire [0:0] tmpOE__EN_C_net;
	wire [0:0] tmpFB_0__EN_C_net;
	wire [0:0] tmpIO_0__EN_C_net;
	wire [0:0] tmpINTERRUPT_0__EN_C_net;
	electrical [0:0] tmpSIOVREF__EN_C_net;

	cy_psoc3_pins_v1_10
		#(.id("24f1660c-6c02-4fc0-b232-07ed424ccf8b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		EN_C
		 (.oe(tmpOE__EN_C_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__EN_C_net[0:0]}),
		  .io({tmpIO_0__EN_C_net[0:0]}),
		  .siovref(tmpSIOVREF__EN_C_net),
		  .interrupt({tmpINTERRUPT_0__EN_C_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__EN_C_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__VREF_C_net;
	wire [0:0] tmpFB_0__VREF_C_net;
	wire [0:0] tmpIO_0__VREF_C_net;
	wire [0:0] tmpINTERRUPT_0__VREF_C_net;
	electrical [0:0] tmpSIOVREF__VREF_C_net;

	cy_psoc3_pins_v1_10
		#(.id("3caf08a7-aa35-43c8-b4d9-c1c2930d1a00"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		VREF_C
		 (.oe(tmpOE__VREF_C_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VREF_C_net[0:0]}),
		  .analog({Net_3059}),
		  .io({tmpIO_0__VREF_C_net[0:0]}),
		  .siovref(tmpSIOVREF__VREF_C_net),
		  .interrupt({tmpINTERRUPT_0__VREF_C_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VREF_C_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    SCB_P4_v3_20_8 EZI2C (
        .cts_in(1'b0),
        .tx_out(Net_87),
        .rts_out(Net_88),
        .interrupt(Net_89),
    ...
    Comp_P4_v1_20_9 Comp_1 (
        .Vplus(Net_171),
        .CmpOut(Net_482),
        .Vminus(Net_173));

	wire [0:0] tmpOE__MAX_I_net;
	wire [0:0] tmpFB_0__MAX_I_net;
	wire [0:0] tmpIO_0__MAX_I_net;
	wire [0:0] tmpINTERRUPT_0__MAX_I_net;
	electrical [0:0] tmpSIOVREF__MAX_I_net;

	cy_psoc3_pins_v1_10
		#(.id("f6588efb-eb64-40d3-b76e-7f3d2c279cf4"),
		  .drive_mode(3'b101),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		MAX_I
		 (.oe(tmpOE__MAX_I_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MAX_I_net[0:0]}),
		  .analog({Net_173}),
		  .io({tmpIO_0__MAX_I_net[0:0]}),
		  .siovref(tmpSIOVREF__MAX_I_net),
		  .interrupt({tmpINTERRUPT_0__MAX_I_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MAX_I_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__IFB_net;
	wire [0:0] tmpFB_0__IFB_net;
	wire [0:0] tmpIO_0__IFB_net;
	wire [0:0] tmpINTERRUPT_0__IFB_net;
	electrical [0:0] tmpSIOVREF__IFB_net;

	cy_psoc3_pins_v1_10
		#(.id("a3a5fed2-a9f5-41cb-bf68-c187c1860d55"),
		  .drive_mode(3'b101),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		IFB
		 (.oe(tmpOE__IFB_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__IFB_net[0:0]}),
		  .analog({Net_171}),
		  .io({tmpIO_0__IFB_net[0:0]}),
		  .siovref(tmpSIOVREF__IFB_net),
		  .interrupt({tmpINTERRUPT_0__IFB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__IFB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("4aacc9a7-5bd7-4f42-b2a2-2f95a6ca036a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    always @(posedge CLK_A)
    begin
        cy_srff_1 <= (Net_481 | Net_174) & ~Net_482;
    end
    assign Net_174 = cy_srff_1;
    // -- SRFF End --


    assign Net_481 = Net_473 & PWM_OUT;


    assign Net_473 = ~Net_392;


	cy_clock_v1_0
		#(.id("59b4d04d-1971-47ba-8732-c973bac76e6c"),
		  .source_clock_id("3E3A6273-3DC0-49b9-A765-A81596A23306"),
		  .divisor(0),
		  .period("0"),
		  .is_direct(1),
		  .is_digital(0))
    ...
    assign Net_145 = Net_174 & PWM_OUT;
