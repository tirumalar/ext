...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDBIF_INT_CLK_CTL, 0x01u);
	{
		...
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL1), 0x30000000u);
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA0_CFG8), 0xFF000000u);

		/* UDB_PA_1 Starting address: CYDEV_UDB_PA1_BASE */
		CY_SET_REG32((void *)(CYDEV_UDB_PA1_BASE), 0x00990000u);
		CY_SET_REG32((void *)(CYREG_UDB_PA1_CFG8), 0xC0000000u);
	...
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT1_BASE), 0x000000A0u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT1_PC), 0x00C2D1B0u);
