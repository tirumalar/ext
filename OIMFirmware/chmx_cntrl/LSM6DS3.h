 ...
 */
  ...
  enum accel_scale
    {
        A_SCALE_2G = 0x0<<2, // 00: +/- 2g
        A_SCALE_16G= 0x1<<2,// 01: +/- 16g
        A_SCALE_4G= 0x2<<2, // 10: +/- 4g
        A_SCALE_8G= 0x3<<2  // 11: +/- 8g
    };

    /// accel_oder defines all possible output data rates of the accelerometer:
    enum accel_odr
    {
        A_POWER_DOWN = 0x0<< 4,   // Power-down mode (0x0)
        A_ODR_13     = 0x1<< 4,       // 12.5 Hz (0x1)        low power
        A_ODR_26     = 0x2<< 4,       // 26 Hz (0x2)          low power
        A_ODR_52     = 0x3<< 4,       // 52 Hz (0x3)          low power
        A_ODR_104    = 0x4<< 4,      // 104 Hz (0x4)         normal mode
        A_ODR_208    = 0x5<< 4,      // 208 Hz (0x5)         normal mode
        A_ODR_416    = 0x6<< 4,      // 416 Hz (0x6)         high performance
        A_ODR_833    = 0x7<< 4,      // 833 Hz (0x7)         high performance
        A_ODR_1660   = 0x8<< 4,     // 1.66 kHz (0x8)       high performance
        A_ODR_3330   = 0x9<< 4,     // 3.33 kHz (0x9)       high performance
        A_ODR_6660   = 0xa<< 4,     // 6.66 kHz (0xA)       high performance
    };
    enum accel_bw
    {
        A_BW_400 = 0x0,  // 
        A_BW_200 = 0x1,         // 408 Hz (0x4)
        A_BW_100 = 0x2,         // 211 Hz (0x5)
        A_BW_50  = 0x3           // 50 Hz (0x7)
    };
