...
void ADC_SAR_Seq_1_Init(void)
{
    ...
    int32 counts;
        ...
        static const uint8 CYCODE ADC_SAR_Seq_1_InputsPlacement[] =
        {
            ...
            #if(ADC_SAR_Seq_1_TOTAL_CHANNELS_NUM > 9u)
                ,(uint8)(ADC_SAR_Seq_1_cy_psoc4_sarmux_8__CH_9_PORT << 4u) |
                 (uint8)ADC_SAR_Seq_1_cy_psoc4_sarmux_8__CH_9_PIN
            #endif /* End ADC_SAR_Seq_1_TOTAL_CHANNELS_NUM > 9u */
            #if(ADC_SAR_Seq_1_TOTAL_CHANNELS_NUM > 10u)
                ,(uint8)(ADC_SAR_Seq_1_cy_psoc4_sarmux_8__CH_10_PORT << 4u) |
                 (uint8)ADC_SAR_Seq_1_cy_psoc4_sarmux_8__CH_10_PIN
            #endif /* End ADC_SAR_Seq_1_TOTAL_CHANNELS_NUM > 10u */
            #if(ADC_SAR_Seq_1_TOTAL_CHANNELS_NUM > 11u)
                ,(uint8)(ADC_SAR_Seq_1_cy_psoc4_sarmux_8__CH_11_PORT << 4u) |
                 (uint8)ADC_SAR_Seq_1_cy_psoc4_sarmux_8__CH_11_PIN
            #endif /* End ADC_SAR_Seq_1_TOTAL_CHANNELS_NUM > 11u */
            #if(ADC_SAR_Seq_1_TOTAL_CHANNELS_NUM > 12u)
                ,(uint8)(ADC_SAR_Seq_1_cy_psoc4_sarmux_8__CH_12_PORT << 4u) |
                 (uint8)ADC_SAR_Seq_1_cy_psoc4_sarmux_8__CH_12_PIN
            #endif /* End ADC_SAR_Seq_1_TOTAL_CHANNELS_NUM > 12u */
            #if(ADC_SAR_Seq_1_TOTAL_CHANNELS_NUM > 13u)
                ,(uint8)(ADC_SAR_Seq_1_cy_psoc4_sarmux_8__CH_13_PORT << 4u) |
                 (uint8)ADC_SAR_Seq_1_cy_psoc4_sarmux_8__CH_13_PIN
            #endif /* End ADC_SAR_Seq_1_TOTAL_CHANNELS_NUM > 13u */
            #if(ADC_SAR_Seq_1_TOTAL_CHANNELS_NUM > 14u)
                ,(uint8)(ADC_SAR_Seq_1_cy_psoc4_sarmux_8__CH_14_PORT << 4u) |
                 (uint8)ADC_SAR_Seq_1_cy_psoc4_sarmux_8__CH_14_PIN
            #endif /* End ADC_SAR_Seq_1_TOTAL_CHANNELS_NUM > 14u */
            #if(ADC_SAR_Seq_1_TOTAL_CHANNELS_NUM > 15u)
                ,(uint8)(ADC_SAR_Seq_1_cy_psoc4_sarmux_8__CH_15_PORT << 4u) |
                 (uint8)ADC_SAR_Seq_1_cy_psoc4_sarmux_8__CH_15_PIN
            #endif /* End ADC_SAR_Seq_1_TOTAL_CHANNELS_NUM > 15u */
            #if(ADC_SAR_Seq_1_TOTAL_CHANNELS_NUM > 16u)
                ,(uint8)(ADC_SAR_Seq_1_cy_psoc4_sarmux_8__CH_16_PORT << 4u) |
                 (uint8)ADC_SAR_Seq_1_cy_psoc4_sarmux_8__CH_16_PIN
            #endif /* End ADC_SAR_Seq_1_TOTAL_CHANNELS_NUM > 16u */
        };
