// ======================================================================
// camera_boot.v generated from TopDesign.cysch
// 10/18/2018 at 13:56
...
module top ;
	...
	wire [0:0] tmpOE__VREFB_net;
	wire [0:0] tmpFB_0__VREFB_net;
	wire [0:0] tmpIO_0__VREFB_net;
	wire [0:0] tmpINTERRUPT_0__VREFB_net;
	electrical [0:0] tmpSIOVREF__VREFB_net;

	cy_psoc3_pins_v1_10
		#(.id("20485ae6-3a02-4282-8d2c-5acd3e63d343"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		VREFB
		 (.oe(tmpOE__VREFB_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VREFB_net[0:0]}),
		  .io({tmpIO_0__VREFB_net[0:0]}),
		  .siovref(tmpSIOVREF__VREFB_net),
		  .interrupt({tmpINTERRUPT_0__VREFB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VREFB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__VREFA_net;
	wire [0:0] tmpFB_0__VREFA_net;
	wire [0:0] tmpIO_0__VREFA_net;
	wire [0:0] tmpINTERRUPT_0__VREFA_net;
	electrical [0:0] tmpSIOVREF__VREFA_net;

	cy_psoc3_pins_v1_10
		#(.id("2608d354-dc71-49d1-b3dc-8481037756c3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		VREFA
		 (.oe(tmpOE__VREFA_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VREFA_net[0:0]}),
		  .io({tmpIO_0__VREFA_net[0:0]}),
		  .siovref(tmpSIOVREF__VREFA_net),
		  .interrupt({tmpINTERRUPT_0__VREFA_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VREFA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__VREFC_net;
	wire [0:0] tmpFB_0__VREFC_net;
	wire [0:0] tmpIO_0__VREFC_net;
	wire [0:0] tmpINTERRUPT_0__VREFC_net;
	electrical [0:0] tmpSIOVREF__VREFC_net;

	cy_psoc3_pins_v1_10
		#(.id("643d88c2-691b-4b73-bc74-e345a1055c04"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		VREFC
		 (.oe(tmpOE__VREFC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VREFC_net[0:0]}),
		  .io({tmpIO_0__VREFC_net[0:0]}),
		  .siovref(tmpSIOVREF__VREFC_net),
		  .interrupt({tmpINTERRUPT_0__VREFC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VREFC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
