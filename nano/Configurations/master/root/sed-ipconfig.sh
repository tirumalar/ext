...
case $scriptOpt in
	...
	"GRITrigger_WeigandEnable")
 	...
 	"GRITrigger_WeigandHidEnable")
                GRITrigger_WeigandHidEnable="$2"
                exec_sed_cmd_1  "GRITrigger.WeigandHidEnable"  "$GRITrigger_WeigandHidEnable"
                ;;

        "GRITrigger_PACEnable")
                GRITrigger_PACEnable="$2"
                exec_sed_cmd_1  "GRITrigger.PACEnable"  "$GRITrigger_PACEnable"
                ;;
	...
	"GRITrigger_DualAuthN")
		GRITrigger_DualAuthN_HasValue="$2"
		exec_sed_cmd_1  "GRITrigger.DualAuthenticationMode"  "$GRITrigger_DualAuthN_HasValue"
		Eyelock_EnableNegativeMatchTimeout_HasValue="$3"
		exec_sed_cmd_1  "Eyelock.EnableNegativeMatchTimeout"  "$Eyelock_EnableNegativeMatchTimeout_HasValue"
		Eyelock_NegativeMatchTimeout_HasValue="$4"
		exec_sed_cmd_1  "Eyelock.NegativeMatchTimeout"  "$Eyelock_NegativeMatchTimeout_HasValue"
		Eyelock_NegativeMatchResetTimer_HasValue="$5"
		exec_sed_cmd_1  "Eyelock.NegativeMatchResetTimer"  "$Eyelock_NegativeMatchResetTimer_HasValue"
		;;
    ...
    "rdCfg_DualAuthN")
        GRITrigger_DualAuthN_rdCfg="$2"
        exec_sed_cmd_1  "GRITrigger.DualAuthenticationMode"  "$GRITrigger_DualAuthN_rdCfg"
        ;;
    "rdCfg_EnableNegativeMatchTimeout")
        Eyelock_EnableNegativeMatchTimeout_rdCfg="$2"
        exec_sed_cmd_1  "Eyelock.EnableNegativeMatchTimeout"  "$Eyelock_EnableNegativeMatchTimeout_rdCfg"
        ;;
    "rdCfg_NegativeMatchTimeout")
        Eyelock_NegativeMatchTimeout_rdCfg="$2"
        exec_sed_cmd_1  "Eyelock.NegativeMatchTimeout"  "$Eyelock_NegativeMatchTimeout_rdCfg"
        ;;
    "rdCfg_NegativeMatchResetTimer")
        Eyelock_NegativeMatchResetTimer_rdCfg="$2"
        exec_sed_cmd_1  "Eyelock.NegativeMatchResetTimer"  "$Eyelock_NegativeMatchResetTimer_rdCfg"
        ;;
	...
	"rdCfg_CameraRecipe")
		GRI_CameraRecipe_rdCfg="$2"
		exec_sed_cmd_1  "GRI.CameraRecipe"  "$GRI_CameraRecipe_rdCfg"
		;;
		
        "rdCfg_TrigWeigandHidEn")
                GRITrigger_WeigandHidEnable_rdCfg="$2"
                exec_sed_cmd_1  "GRITrigger.WeigandHidEnable"  "$GRITrigger_WeigandHidEnable_rdCfg"
                ;;

        "rdCfg_TrigPACEn")
                GRITrigger_PACEnable_rdCfg="$2"
                exec_sed_cmd_1  "GRITrigger.PACEnable"  "$GRITrigger_PACEnable_rdCfg"
                ;;
