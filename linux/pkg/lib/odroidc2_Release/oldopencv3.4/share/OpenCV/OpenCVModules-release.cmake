...
set_target_properties(opencv_phase_unwrapping PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopencv_phase_unwrapping.so.3.4.0"
  IMPORTED_SONAME_RELEASE "libopencv_phase_unwrapping.so.3.4"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_phase_unwrapping )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_phase_unwrapping "${_IMPORT_PREFIX}/lib/libopencv_phase_unwrapping.so.3.4.0" )
...
set_target_properties(opencv_plot PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopencv_plot.so.3.4.0"
  IMPORTED_SONAME_RELEASE "libopencv_plot.so.3.4"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_plot )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_plot "${_IMPORT_PREFIX}/lib/libopencv_plot.so.3.4.0" )
...
set_target_properties(opencv_reg PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopencv_reg.so.3.4.0"
  IMPORTED_SONAME_RELEASE "libopencv_reg.so.3.4"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_reg )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_reg "${_IMPORT_PREFIX}/lib/libopencv_reg.so.3.4.0" )
...
set_target_properties(opencv_surface_matching PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopencv_surface_matching.so.3.4.0"
  IMPORTED_SONAME_RELEASE "libopencv_surface_matching.so.3.4"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_surface_matching )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_surface_matching "${_IMPORT_PREFIX}/lib/libopencv_surface_matching.so.3.4.0" )
...
set_target_properties(opencv_xphoto PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopencv_xphoto.so.3.4.0"
  IMPORTED_SONAME_RELEASE "libopencv_xphoto.so.3.4"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_xphoto )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_xphoto "${_IMPORT_PREFIX}/lib/libopencv_xphoto.so.3.4.0" )
...
set_target_properties(opencv_freetype PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopencv_freetype.so.3.4.0"
  IMPORTED_SONAME_RELEASE "libopencv_freetype.so.3.4"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_freetype )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_freetype "${_IMPORT_PREFIX}/lib/libopencv_freetype.so.3.4.0" )
...
set_target_properties(opencv_fuzzy PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopencv_fuzzy.so.3.4.0"
  IMPORTED_SONAME_RELEASE "libopencv_fuzzy.so.3.4"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_fuzzy )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_fuzzy "${_IMPORT_PREFIX}/lib/libopencv_fuzzy.so.3.4.0" )
...
set_target_properties(opencv_img_hash PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopencv_img_hash.so.3.4.0"
  IMPORTED_SONAME_RELEASE "libopencv_img_hash.so.3.4"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_img_hash )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_img_hash "${_IMPORT_PREFIX}/lib/libopencv_img_hash.so.3.4.0" )
...
set_target_properties(opencv_xobjdetect PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopencv_xobjdetect.so.3.4.0"
  IMPORTED_SONAME_RELEASE "libopencv_xobjdetect.so.3.4"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_xobjdetect )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_xobjdetect "${_IMPORT_PREFIX}/lib/libopencv_xobjdetect.so.3.4.0" )
...
set_target_properties(opencv_bioinspired PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopencv_bioinspired.so.3.4.0"
  IMPORTED_SONAME_RELEASE "libopencv_bioinspired.so.3.4"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_bioinspired )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_bioinspired "${_IMPORT_PREFIX}/lib/libopencv_bioinspired.so.3.4.0" )
...
set_target_properties(opencv_dpm PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopencv_dpm.so.3.4.0"
  IMPORTED_SONAME_RELEASE "libopencv_dpm.so.3.4"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_dpm )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_dpm "${_IMPORT_PREFIX}/lib/libopencv_dpm.so.3.4.0" )
...
set_target_properties(opencv_line_descriptor PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopencv_line_descriptor.so.3.4.0"
  IMPORTED_SONAME_RELEASE "libopencv_line_descriptor.so.3.4"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_line_descriptor )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_line_descriptor "${_IMPORT_PREFIX}/lib/libopencv_line_descriptor.so.3.4.0" )
...
set_target_properties(opencv_saliency PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopencv_saliency.so.3.4.0"
  IMPORTED_SONAME_RELEASE "libopencv_saliency.so.3.4"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_saliency )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_saliency "${_IMPORT_PREFIX}/lib/libopencv_saliency.so.3.4.0" )
...
set_target_properties(opencv_text PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopencv_text.so.3.4.0"
  IMPORTED_SONAME_RELEASE "libopencv_text.so.3.4"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_text )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_text "${_IMPORT_PREFIX}/lib/libopencv_text.so.3.4.0" )
...
set_target_properties(opencv_ccalib PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopencv_ccalib.so.3.4.0"
  IMPORTED_SONAME_RELEASE "libopencv_ccalib.so.3.4"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_ccalib )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_ccalib "${_IMPORT_PREFIX}/lib/libopencv_ccalib.so.3.4.0" )
...
set_target_properties(opencv_datasets PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopencv_datasets.so.3.4.0"
  IMPORTED_SONAME_RELEASE "libopencv_datasets.so.3.4"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_datasets )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_datasets "${_IMPORT_PREFIX}/lib/libopencv_datasets.so.3.4.0" )
...
set_target_properties(opencv_rgbd PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopencv_rgbd.so.3.4.0"
  IMPORTED_SONAME_RELEASE "libopencv_rgbd.so.3.4"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_rgbd )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_rgbd "${_IMPORT_PREFIX}/lib/libopencv_rgbd.so.3.4.0" )
...
set_target_properties(opencv_stereo PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopencv_stereo.so.3.4.0"
  IMPORTED_SONAME_RELEASE "libopencv_stereo.so.3.4"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_stereo )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_stereo "${_IMPORT_PREFIX}/lib/libopencv_stereo.so.3.4.0" )
...
set_target_properties(opencv_structured_light PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopencv_structured_light.so.3.4.0"
  IMPORTED_SONAME_RELEASE "libopencv_structured_light.so.3.4"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_structured_light )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_structured_light "${_IMPORT_PREFIX}/lib/libopencv_structured_light.so.3.4.0" )
...
set_target_properties(opencv_tracking PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopencv_tracking.so.3.4.0"
  IMPORTED_SONAME_RELEASE "libopencv_tracking.so.3.4"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_tracking )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_tracking "${_IMPORT_PREFIX}/lib/libopencv_tracking.so.3.4.0" )
...
set_target_properties(opencv_xfeatures2d PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopencv_xfeatures2d.so.3.4.0"
  IMPORTED_SONAME_RELEASE "libopencv_xfeatures2d.so.3.4"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_xfeatures2d )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_xfeatures2d "${_IMPORT_PREFIX}/lib/libopencv_xfeatures2d.so.3.4.0" )
...
set_target_properties(opencv_ximgproc PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopencv_ximgproc.so.3.4.0"
  IMPORTED_SONAME_RELEASE "libopencv_ximgproc.so.3.4"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_ximgproc )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_ximgproc "${_IMPORT_PREFIX}/lib/libopencv_ximgproc.so.3.4.0" )
...
set_target_properties(opencv_aruco PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopencv_aruco.so.3.4.0"
  IMPORTED_SONAME_RELEASE "libopencv_aruco.so.3.4"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_aruco )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_aruco "${_IMPORT_PREFIX}/lib/libopencv_aruco.so.3.4.0" )
...
set_target_properties(opencv_bgsegm PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopencv_bgsegm.so.3.4.0"
  IMPORTED_SONAME_RELEASE "libopencv_bgsegm.so.3.4"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_bgsegm )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_bgsegm "${_IMPORT_PREFIX}/lib/libopencv_bgsegm.so.3.4.0" )
...
set_target_properties(opencv_face PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopencv_face.so.3.4.0"
  IMPORTED_SONAME_RELEASE "libopencv_face.so.3.4"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_face )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_face "${_IMPORT_PREFIX}/lib/libopencv_face.so.3.4.0" )
...
set_target_properties(opencv_optflow PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopencv_optflow.so.3.4.0"
  IMPORTED_SONAME_RELEASE "libopencv_optflow.so.3.4"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_optflow )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_optflow "${_IMPORT_PREFIX}/lib/libopencv_optflow.so.3.4.0" )
