// ======================================================================
// nanoNxt_ICM3_Bootlaoder.v generated from TopDesign.cysch
// 12/29/2014 at 16:48
...
module top ;
	...
	wire [0:0] tmpOE__Pin_SCL_net;
	wire [0:0] tmpFB_0__Pin_SCL_net;
	wire [0:0] tmpINTERRUPT_0__Pin_SCL_net;
	electrical [0:0] tmpSIOVREF__Pin_SCL_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("02f2cf2c-2c7a-49df-9246-7a3435c21be3"),
		  ...
		  .width(1))
		Pin_SCL
		 (.oe(tmpOE__Pin_SCL_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_SCL_net[0:0]}),
		  .io({Net_13}),
		  .siovref(tmpSIOVREF__Pin_SCL_net),
		  .interrupt({tmpINTERRUPT_0__Pin_SCL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_SCL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_SDA_net;
	wire [0:0] tmpFB_0__Pin_SDA_net;
	wire [0:0] tmpINTERRUPT_0__Pin_SDA_net;
	electrical [0:0] tmpSIOVREF__Pin_SDA_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("22863ebe-a37b-476f-b252-6e49a8c00b12"),
		  ...
		  .width(1))
		Pin_SDA
		 (.oe(tmpOE__Pin_SDA_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_SDA_net[0:0]}),
		  .io({Net_12}),
		  .siovref(tmpSIOVREF__Pin_SDA_net),
		  .interrupt({tmpINTERRUPT_0__Pin_SDA_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_SDA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    I2C_v3_30_0 I2CSlave (
        .sda(Net_12),
        .scl(Net_13),
        .clock(1'b0),
        .reset(1'b0),
	...
	wire [0:0] tmpOE__LED_01_net;
	wire [0:0] tmpFB_0__LED_01_net;
	wire [0:0] tmpIO_0__LED_01_net;
	wire [0:0] tmpINTERRUPT_0__LED_01_net;
	electrical [0:0] tmpSIOVREF__LED_01_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("0e0c9380-6965-4440-8709-ce08a91e474c"),
		  ...
		  .width(1))
		LED_01
		 (.oe(tmpOE__LED_01_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_01_net[0:0]}),
		  .io({tmpIO_0__LED_01_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_01_net),
		  .interrupt({tmpINTERRUPT_0__LED_01_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_01_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_02_net;
	wire [0:0] tmpFB_0__LED_02_net;
	wire [0:0] tmpIO_0__LED_02_net;
	wire [0:0] tmpINTERRUPT_0__LED_02_net;
	electrical [0:0] tmpSIOVREF__LED_02_net;

	cy_psoc3_pins_v1_10
		#(.id("7e3e1c63-1a4f-44e2-939e-f420b7cae8ab"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .width(1))
		LED_02
		 (.oe(tmpOE__LED_02_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_02_net[0:0]}),
		  .io({tmpIO_0__LED_02_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_02_net),
		  .interrupt({tmpINTERRUPT_0__LED_02_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_02_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_03_net;
	wire [0:0] tmpFB_0__LED_03_net;
	wire [0:0] tmpIO_0__LED_03_net;
	wire [0:0] tmpINTERRUPT_0__LED_03_net;
	electrical [0:0] tmpSIOVREF__LED_03_net;

	cy_psoc3_pins_v1_10
		#(.id("cb1cf550-f388-4b03-96b0-50609b9b0f9c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .width(1))
		LED_03
		 (.oe(tmpOE__LED_03_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_03_net[0:0]}),
		  .io({tmpIO_0__LED_03_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_03_net),
		  .interrupt({tmpINTERRUPT_0__LED_03_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_03_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
