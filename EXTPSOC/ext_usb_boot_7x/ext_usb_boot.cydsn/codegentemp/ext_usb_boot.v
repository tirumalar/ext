// ======================================================================
// ext_usb_boot.v generated from TopDesign.cysch
// 02/13/2019 at 10:51
...
module top ;
	...
	wire [0:0] tmpOE__ST_LED_0_net;
	wire [0:0] tmpFB_0__ST_LED_0_net;
	wire [0:0] tmpIO_0__ST_LED_0_net;
	wire [0:0] tmpINTERRUPT_0__ST_LED_0_net;
	electrical [0:0] tmpSIOVREF__ST_LED_0_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("0d27b68f-4834-432a-b261-f3fbcbf093a6"),
		  ...
		  .input_buffer_sel(2'b00))
		ST_LED_0
		 (.oe(tmpOE__ST_LED_0_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ST_LED_0_net[0:0]}),
		  .io({tmpIO_0__ST_LED_0_net[0:0]}),
		  .siovref(tmpSIOVREF__ST_LED_0_net),
		  .interrupt({tmpINTERRUPT_0__ST_LED_0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ST_LED_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ST_LED_1_net;
	wire [0:0] tmpFB_0__ST_LED_1_net;
	wire [0:0] tmpIO_0__ST_LED_1_net;
	wire [0:0] tmpINTERRUPT_0__ST_LED_1_net;
	electrical [0:0] tmpSIOVREF__ST_LED_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("6feb91d6-b8b2-4599-811d-4fe50ed85ce0"),
		  ...
		  .input_buffer_sel(2'b00))
		ST_LED_1
		 (.oe(tmpOE__ST_LED_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ST_LED_1_net[0:0]}),
		  .io({tmpIO_0__ST_LED_1_net[0:0]}),
		  .siovref(tmpSIOVREF__ST_LED_1_net),
		  .interrupt({tmpINTERRUPT_0__ST_LED_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ST_LED_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ST_LED_2_net;
	wire [0:0] tmpFB_0__ST_LED_2_net;
	wire [0:0] tmpIO_0__ST_LED_2_net;
	wire [0:0] tmpINTERRUPT_0__ST_LED_2_net;
	electrical [0:0] tmpSIOVREF__ST_LED_2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("4c662043-81af-404a-9b15-6e03ec45ab6c"),
		  ...
		  .input_buffer_sel(2'b00))
		ST_LED_2
		 (.oe(tmpOE__ST_LED_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ST_LED_2_net[0:0]}),
		  .io({tmpIO_0__ST_LED_2_net[0:0]}),
		  .siovref(tmpSIOVREF__ST_LED_2_net),
		  .interrupt({tmpINTERRUPT_0__ST_LED_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ST_LED_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
