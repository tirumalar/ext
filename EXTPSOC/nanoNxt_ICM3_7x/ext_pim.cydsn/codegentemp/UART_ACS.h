...
/* Only if RX is enabled */
    ...
    uint16 UART_ACS_GetByte(void) ;
    uint16 UART_ACS_GetRxBufferSize(void)
                                                            ;
...
extern uint8 UART_ACS_initVar;
    ...
    extern volatile uint16 UART_ACS_rxBufferRead;
    extern volatile uint16 UART_ACS_rxBufferWrite;
