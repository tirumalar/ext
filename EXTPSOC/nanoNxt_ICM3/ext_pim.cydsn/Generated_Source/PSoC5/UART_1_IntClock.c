...
*
*******************************************************************************/
void UART_1_IntClock_SetDividerRegister(unsigned short clkDivider, uint8 restart)
                                
{
    uint8 enabled;

    uint8 currSrc = UART_1_IntClock_GetSourceRegister();
    unsigned short oldDivider = UART_1_IntClock_GetDividerRegister();
...
*
*******************************************************************************/
unsigned short UART_1_IntClock_GetDividerRegister(void) 
{
...
{
    unsigned short currDiv = UART_1_IntClock_GetDividerRegister();
