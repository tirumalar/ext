...
CY_ISR(I2C_Master_ISR)
{
...
#ifdef I2C_Master_ISR_ENTRY_CALLBACK
    I2C_Master_ISR_EntryCallback();
#endif /* I2C_Master_ISR_ENTRY_CALLBACK */
        ...
        if(I2C_Master_CHECK_BYTE_COMPLETE(tmpCsr))
        {
            ...
            /* Check for software address detection */
                ...
                if(tmp8 == I2C_Master_slAddress)   /* Check for address match */
                {
                    ...
                    #ifdef I2C_Master_SW_PREPARE_READ_BUF_CALLBACK
                        I2C_Master_SwPrepareReadBuf_Callback();
                    #endif /* I2C_Master_SW_PREPARE_READ_BUF_CALLBACK */
                ...
                #ifdef I2C_Master_SW_ADDR_COMPARE_ENTRY_CALLBACK
                    I2C_Master_SwAddrCompare_EntryCallback();
                #endif /* I2C_Master_SW_ADDR_COMPARE_ENTRY_CALLBACK */
                ...
                #ifdef I2C_Master_SW_ADDR_COMPARE_EXIT_CALLBACK
                    I2C_Master_SwAddrCompare_ExitCallback();
                #endif /* I2C_Master_SW_ADDR_COMPARE_EXIT_CALLBACK */
                }
                ...
                #ifdef I2C_Master_HW_PREPARE_READ_BUF_CALLBACK
                    I2C_Master_HwPrepareReadBuf_Callback();
                #endif /* I2C_Master_HW_PREPARE_READ_BUF_CALLBACK */
...
#ifdef I2C_Master_ISR_EXIT_CALLBACK
    I2C_Master_ISR_ExitCallback();
#endif /* I2C_Master_ISR_EXIT_CALLBACK */    
}
    ...
    *******************************************************************************/
    ...
    {
    #ifdef I2C_Master_WAKEUP_ISR_ENTRY_CALLBACK
        I2C_Master_WAKEUP_ISR_EntryCallback();
    #endif /* I2C_Master_WAKEUP_ISR_ENTRY_CALLBACK */
         
        /* Set flag to notify that matched address is received */
        I2C_Master_wakeupSource = 1u;

        /* SCL is stretched until the I2C_Wake() is called */

    #ifdef I2C_Master_WAKEUP_ISR_EXIT_CALLBACK
        I2C_Master_WAKEUP_ISR_ExitCallback();
    #endif /* I2C_Master_WAKEUP_ISR_EXIT_CALLBACK */
    }
