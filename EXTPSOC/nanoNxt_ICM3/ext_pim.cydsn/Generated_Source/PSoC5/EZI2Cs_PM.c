...
EZI2Cs_BACKUP_STRUCT EZI2Cs_backup =
{
    EZI2Cs_DISABLED,
    EZI2Cs_DEFAULT_XCFG,
    EZI2Cs_DEFAULT_ADDR,
    EZI2Cs_DEFAULT_CFG,
    EZI2Cs_DEFAULT_CLKDIV1,
    EZI2Cs_DEFAULT_CLKDIV2
};

#if (EZI2Cs_WAKEUP_ENABLED)
    volatile uint8 EZI2Cs_wakeupSource;
#endif /* (EZI2Cs_WAKEUP_ENABLED) */


/*******************************************************************************
* Function Name: EZI2Cs_SaveConfig
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  EZI2Cs_backup - The non-retention registers are saved to.
*
* Reentrant:
*  No.
*
...
void EZI2Cs_SaveConfig(void) 
{
    ...
    EZI2Cs_backup.cfg     = EZI2Cs_CFG_REG;
    EZI2Cs_backup.xcfg    = EZI2Cs_XCFG_REG;
    ...
    EZI2Cs_PWRSYS_CR1_REG |= EZI2Cs_PWRSYS_CR1_I2C_BACKUP;
    ...
    */
    EZI2Cs_XCFG_REG |= EZI2Cs_XCFG_FORCE_NACK;
    while (0u == (EZI2Cs_XCFG_REG & EZI2Cs_XCFG_SLEEP_READY))
    {
    }

     /* Setup wakeup interrupt */
    EZI2Cs_DisableInt();
    EZI2Cs_wakeupSource = 0u; /* Clear wakeup event */
    (void) CyIntSetVector(EZI2Cs_ISR_NUMBER, &EZI2Cs_WAKEUP_ISR);
    EZI2Cs_EnableInt();
#endif /* (EZI2Cs_WAKEUP_ENABLED) */
}
...
/*******************************************************************************
* Function Name: EZI2Cs_RestoreConfig
********************************************************************************
*
* Summary:
*  The Enable wakeup from Sleep Mode selection influences this function
...
*
* Global variables:
*  EZI2Cs_backup - the non-retention registers are restored from.
*
* Reentrant:
*  No.
*
* Side Effects:
*  Calling this function before EZI2Cs_SaveConfig() or
*  EZI2Cs_Sleep() may produce unexpected behavior.
*
*******************************************************************************/
void EZI2Cs_RestoreConfig(void) 
{
    ...
    if (0u != (EZI2Cs_PWRSYS_CR1_I2C_BACKUP & EZI2Cs_PWRSYS_CR1_REG))
    /* Exit from Sleep */
    {
        /* Disable I2C backup regulator */
        intState = CyEnterCriticalSection();
        EZI2Cs_PWRSYS_CR1_REG &= (uint8) ~EZI2Cs_PWRSYS_CR1_I2C_BACKUP;
    ...
    else /* Exit from Hibernate (bit is cleared) or wakeup disabled */
    {
        ...
        EZI2Cs_backup.enableState = EZI2Cs_ENABLED;
    #endif /* (EZI2Cs_WAKEUP_ENABLED) */

        /* Restore component registers: Hibernate disable power */
        EZI2Cs_CFG_REG     = EZI2Cs_backup.cfg;
        EZI2Cs_XCFG_REG    = EZI2Cs_backup.xcfg;
    ...
    if (0u != EZI2Cs_wakeupSource)
    {
        /* Generate interrupt to release I2C bus */
        (void) CyIntSetPending(EZI2Cs_ISR_NUMBER);
    }
    EZI2Cs_EnableInt();
#endif /* (EZI2Cs_WAKEUP_ENABLED) */
}
...
*
* Global variables:
*  EZI2Cs_backup - The non retention registers are saved to. Changed
*  by EZI2Cs_SaveConfig() function call.
*
* Reentrant:
*  No.
*
...
{
#if (EZI2Cs_WAKEUP_ENABLED)
    /* Do not re-enable component in EZI2Cs_Wakeup(). It remains enabled as it is wakeup source */
    EZI2Cs_backup.enableState = EZI2Cs_DISABLED;
#else
    /* Store component state enabled or disable to restore after wakeup */
    EZI2Cs_backup.enableState = (EZI2Cs_PM_ACT_CFG_REG & EZI2Cs_ACT_PWR_EN);

    if (0u != EZI2Cs_backup.enableState)
    {
...
* Side Effects:
*  Calling this function before EZI2Cs_SaveConfig() or
*  EZI2Cs_Sleep() will lead to unpredictable results.
*
*******************************************************************************/
void EZI2Cs_Wakeup(void) 
{
    EZI2Cs_RestoreConfig();
