...
{
    uint8 staticBits = (LED_0_DR & (uint8)(~LED_0_MASK));
    LED_0_DR = staticBits | ((uint8)(value << LED_0_SHIFT) & LED_0_MASK);
}
...
*
*  LED_0_DM_STRONG     Strong Drive 
*  LED_0_DM_OD_HI      Open Drain, Drives High 
*  LED_0_DM_OD_LO      Open Drain, Drives Low 
*  LED_0_DM_RES_UP     Resistive Pull Up 
*  LED_0_DM_RES_DWN    Resistive Pull Down 
*  LED_0_DM_RES_UPDWN  Resistive Pull Up/Down 
*  LED_0_DM_DIG_HIZ    High Impedance Digital 
*  LED_0_DM_ALG_HIZ    High Impedance Analog 
*
* Return: 
*  None
*
