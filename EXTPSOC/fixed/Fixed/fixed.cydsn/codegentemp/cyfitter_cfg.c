...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)(CYREG_CLK_SELECT02), 0x00000011u);
	CY_SET_REG32((void *)(CYREG_CLK_SELECT03), 0x00000012u);
	CY_SET_REG32((void *)(CYREG_CLK_SELECT08), 0x00000010u);
	CY_SET_REG32((void *)(CYREG_CLK_SELECT09), 0x00000030u);
	CY_SET_REG32((void *)(CYREG_CLK_SELECT10), 0x00000020u);
	CY_SET_REG32((void *)(CYREG_CLK_SELECT13), 0x00000021u);
	CY_SET_REG32((void *)(CYREG_CLK_SELECT15), 0x00000031u);
	...
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_A01), 0x80000002u);

	/* CYDEV_CLK_DIVIDER_B01 Starting address: CYDEV_CLK_DIVIDER_B01 */
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_B01), 0x80000009u);

	/* CYDEV_CLK_DIVIDER_C01 Starting address: CYDEV_CLK_DIVIDER_C01 */
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_C01), 0x8000000Bu);

	/* CYDEV_CLK_DIVIDER_A02 Starting address: CYDEV_CLK_DIVIDER_A02 */
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_A02), 0x8000001Du);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG32((void CYFAR *)CYREG_SAR_MUX_SWITCH0, 0x00300000u);
...
void cyfitter_cfg(void)
{
...

	{
		static const uint32 CYCODE cy_cfg_addr_table[] = {
			...
			0x400F3016u, /* Base address: 0x400F3000 Count: 22 */
			0x400F310Cu, /* Base address: 0x400F3100 Count: 12 */
			0x400F323Eu, /* Base address: 0x400F3200 Count: 62 */
			0x400F332Fu, /* Base address: 0x400F3300 Count: 47 */
		...
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL1), 0x00003060u);
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL2), 0x30000000u);
	...
	CY_SET_REG32((void *)(CYREG_PRT0_PC), 0x002001B6u);
