...
class TServerSocket : public TServerTransport {
 public:
  ...
  // ATH-1537
  // ****
  void setKeepAlive(bool keepAlive = false);
  void setKeepAliveTime(int keepAliveTime = 7200); // seconds. Default kernel value
  void setKeepAliveIntvl(int keepAliveIntvl = 75); // seconds. Default kernel value
  void setKeepAliveProbes(int keepAliveProbes = 9); // Default kernel value
  // ****
