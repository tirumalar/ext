...
#define HOME_SPEED 255//70*2
#define HOME_I 50*2
#define RUN_I 255 +127
#define RUN_I_COUNTER_SPRING 255 +127
   ...
   if (mot_active)
       {
        ...
        if ((active_count>MAX_ACTIVE))//ik disable current sense ||(Comp_ISENSE_GetCompare()==1))
           {
            mot_active=0;
            PWM_M_WriteCompare1(0);
            return 0;
