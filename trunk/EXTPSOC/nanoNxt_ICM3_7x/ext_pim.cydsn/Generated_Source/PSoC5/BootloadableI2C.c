...
static cystatus BootloadableI2C_WriteFlashByte(const uint32 address, const uint8 inputValue) CYLARGE \
                               ;
#endif /*(CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER)*/

/*******************************************************************************
* Function Name: BootloadableI2C_Load
****************************************************************************//**
*
* \brief
...
*
*******************************************************************************/
void BootloadableI2C_Load(void) 
{
    /* Schedule Bootloader to start after reset */
    BootloadableI2C_SET_RUN_TYPE(BootloadableI2C_SCHEDULE_BTLDR);
...
#if (CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER)
/*******************************************************************************
* Function Name: BootloadableI2C_GetActiveApplication
****************************************************************************//**
*
* \brief
...
{   
    uint8 result = BootloadableI2C_MD_BTLDB_ACTIVE_NONE;
    
    if (0u != BootloadableI2C_GET_CODE_DATA( \
              BootloadableI2C_MD_BTLDB_ACTIVE_OFFSET(BootloadableI2C_MD_BTLDB_ACTIVE_0))) 
    {
        result = BootloadableI2C_MD_BTLDB_ACTIVE_0;
    }
    else if (0u != BootloadableI2C_GET_CODE_DATA( \
                   BootloadableI2C_MD_BTLDB_ACTIVE_OFFSET(BootloadableI2C_MD_BTLDB_ACTIVE_1)))
    {
        result = BootloadableI2C_MD_BTLDB_ACTIVE_1;    
    }
    else
    {
...
/*******************************************************************************
* Function Name: BootloadableI2C_SetActiveApplication
****************************************************************************//**
*
* \brief 
                ...
                
{
    ...
    if (appId > BootloadableI2C_MD_BTLDB_ACTIVE_1)
    {
    ...
    else
    {
        ...
        if (1u == BootloadableI2C_GET_CODE_DATA(BootloadableI2C_MD_BTLDB_ACTIVE_OFFSET(appId)))
        {
            result = CYRET_BAD_PARAM;
        }
        else
        {
            ...
            for(idx = 0u; idx < BootloadableI2C_MAX_NUM_OF_BTLDB; idx++)
            {
                result |= BootloadableI2C_WriteFlashByte((uint32) BootloadableI2C_MD_BTLDB_ACTIVE_OFFSET(idx), \
                                                                                            (uint8)(idx == appId));
            }
        }
    }
...
/*******************************************************************************
* Function Name: BootloadableI2C_WriteFlashByte
****************************************************************************//**
*
* \brief 
                               ...
                               
{
    ...
    {
        rowData[idx] = (uint8)BootloadableI2C_GET_CODE_DATA(baseAddr + idx);
    }
...
void BootloadableI2C_SetFlashByte(uint32 address, uint8 runType) 
{
    ...
    for (idx = 0u; idx < CYDEV_FLS_ROW_SIZE; idx++)
    {
        rowData[idx] = BootloadableI2C_GET_CODE_DATA(baseAddr + idx);
    }
