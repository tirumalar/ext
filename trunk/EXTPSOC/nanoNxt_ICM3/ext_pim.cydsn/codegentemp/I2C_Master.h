...
#define I2C_Master_OVERFLOW_RETURN    (0xFFu) /* Send on bus in case of overflow */
    ...
    /* Master status */
    #define I2C_Master_MSTAT_CLEAR            (0x00u) /* Clear (initialize) status value */
...
#define  I2C_Master_SM_SL_WR_DATA     (0x11u) /* Master writes data to slave  */
...
***************************************/
    ...
    #define I2C_Master_CFG_REG \
            (*(reg8 *) I2C_Master_bI2C_UDB_SyncCtl_CtrlReg__CONTROL_REG)
    #define I2C_Master_CFG_PTR \
            ( (reg8 *) I2C_Master_bI2C_UDB_SyncCtl_CtrlReg__CONTROL_REG)
    ...
    #define I2C_Master_GO_DONE_REG    (*(reg8 *) I2C_Master_bI2C_UDB_Shifter_u0__A1_REG)
    #define I2C_Master_GO_DONE_PTR    ( (reg8 *) I2C_Master_bI2C_UDB_Shifter_u0__A1_REG)
    ...
    #define I2C_Master_MCLK_CMP_PTR   ( (reg8 *) I2C_Master_bI2C_UDB_Master_ClkGen_u0__D1_REG)
        ...
        #define I2C_Master_COUNTER_AUX_CTL_REG \
                                    (*(reg8 *) I2C_Master_bI2C_UDB_Slave_BitCounter__CONTROL_AUX_CTL_REG)
        #define I2C_Master_COUNTER_AUX_CTL_PTR \
                                    ( (reg8 *) I2C_Master_bI2C_UDB_Slave_BitCounter__CONTROL_AUX_CTL_REG)
...
#define I2C_Master_CLEAR_REG          (0x00u)
#define I2C_Master_BLOCK_RESET_DELAY  (2u)
#define I2C_Master_FF_RESET_DELAY     (I2C_Master_BLOCK_RESET_DELAY)
#define I2C_Master_RESTORE_TIMEOUT    (255u)
    ...
    #define I2C_Master_XCFG_FORCE_NACK    (0x10u) /* Force NACK all incoming transactions */
    ...
    #define I2C_Master_CFG_CLK_RATE_MSK   (0x0Cu) /* Clock rate select */
    ...
    #define I2C_Master_CSR_BUS_ERROR      (0x80u) /* Active high when bus error has occurred */
    ...
    #define I2C_Master_CSR_RDY_TO_RD      (0x00u) /* Set to receive mode */
    ...
    #define I2C_Master_INT_ENABLE_MASK            (0x10u) /* Enable interrupt from status register */
...
#define I2C_Master_GET_SLAVE_ADDR(dataReg)   (((dataReg) >> I2C_Master_SLAVE_ADDR_SHIFT) & \
    ...
    #define I2C_Master_GENERATE_START_MANUAL      I2C_Master_GENERATE_START
    ...
    #define I2C_Master_BUS_RELEASE_MANUAL         I2C_Master_BUS_RELEASE
    ...
    #define I2C_Master_MCSR_REG           (I2C_Master_CSR_REG)  /* UDB incorporates master and slave regs */
    #define I2C_Master_MCSR_BUS_BUSY      (I2C_Master_STS_BUSY_MASK)      /* Is bus is busy               */
    #define I2C_Master_MCSR_START_GEN     (I2C_Master_CTRL_START_MASK)    /* Generate Start condition     */
    ...
    #define I2C_Master_PREPARE_TO_RELEASE (0xFFu)
    #define I2C_Master_RELEASE_FSM        (0x00u)

    /* Define release command done: history of byte complete status is cleared */
    #define I2C_Master_WAIT_RELEASE_CMD_DONE  (I2C_Master_RELEASE_FSM != I2C_Master_GO_DONE_REG)
    ...
    /* Receive data */
    #define I2C_Master_READY_TO_READ  \
                                        do{ \
    ...
    #define I2C_Master_NAK_AND_RECEIVE \
                                        do{  \
                                            I2C_Master_CFG_REG     = (I2C_Master_CTRL_NACK_MASK |   \
                                                                            I2C_Master_CTRL_DEFAULT);     \
                                            I2C_Master_GO_DONE_REG = I2C_Master_PREPARE_TO_RELEASE; \
    ...
    #define I2C_Master_GENERATE_START \
                                        do{ \
    ...
    #define I2C_Master_GENERATE_START_MANUAL \
                                        do{ \
                                            I2C_Master_GENERATE_START;                  \
                                            /* Wait until byte complete history is cleared */ \
                                            while(I2C_Master_WAIT_RELEASE_CMD_DONE)     \
                                            {                                                 \
                                            }                                                 \
                                        }while(0)
    ...
    #define I2C_Master_BUS_RELEASE_MANUAL I2C_Master_READY_TO_READ_MANUAL
...
#define I2C_Master_ENABLE     (1u)
    ...
    #define I2C_Master_DEFAULT_CLK_RATE   (I2C_Master_DEFAULT_CLK_RATE1)
    ...
    #define I2C_Master_DEFAULT_DIVIDE_FACTOR  ((uint16) 1u)
