...
module top ;
	...
	wire [0:0] tmpOE__RESIST_1_net;
	wire [0:0] tmpFB_0__RESIST_1_net;
	wire [0:0] tmpIO_0__RESIST_1_net;
	wire [0:0] tmpINTERRUPT_0__RESIST_1_net;
	electrical [0:0] tmpSIOVREF__RESIST_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("f6588efb-eb64-40d3-b76e-7f3d2c279cf4"),
		  ...
		  .input_buffer_sel(2'b00))
		RESIST_1
		 (.oe(tmpOE__RESIST_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RESIST_1_net[0:0]}),
		  .analog({Net_171}),
		  .io({tmpIO_0__RESIST_1_net[0:0]}),
		  .siovref(tmpSIOVREF__RESIST_1_net),
		  .interrupt({tmpINTERRUPT_0__RESIST_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RESIST_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__RESIST_2_net;
	wire [0:0] tmpFB_0__RESIST_2_net;
	wire [0:0] tmpIO_0__RESIST_2_net;
	wire [0:0] tmpINTERRUPT_0__RESIST_2_net;
	electrical [0:0] tmpSIOVREF__RESIST_2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("a3a5fed2-a9f5-41cb-bf68-c187c1860d55"),
		  ...
		  .input_buffer_sel(2'b00))
		RESIST_2
		 (.oe(tmpOE__RESIST_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RESIST_2_net[0:0]}),
		  .analog({Net_173}),
		  .io({tmpIO_0__RESIST_2_net[0:0]}),
		  .siovref(tmpSIOVREF__RESIST_2_net),
		  .interrupt({tmpINTERRUPT_0__RESIST_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RESIST_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_145 = Net_174 & Net_177;
