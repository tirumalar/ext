...
namespace logview4net
{
    ...
    {
		// Add unique session types here for whatever sessions you want...
        ...
        private ConfiguratorBase _viewerConfigurator;// = new textConfigurator();
		...
		private SESSION_TYPE _sessionType;
        ...
        /// </summary>
        public ConfigureSession(SESSION_TYPE st)
        {
            InitializeComponent();
			...
			{
				//case default:
				case SESSION_TYPE.TEXTLOG:
				{
					_viewerConfigurator = new textConfigurator();
					break;
				}

				case SESSION_TYPE.EXTLOG:
				{
					_viewerConfigurator = new extLogConfigurator();
					break;
				}
			}

            _session = new Session();
            _session.Viewer = (IViewer)_viewerConfigurator.Viewer;
        ...
        /// Initializes a new instance of the <see cref="ConfigureSession"/> class.
        /// </summary>
        public ConfigureSession(ListenerBase listenerBase, IViewer viewer)
        {
            InitializeComponent();
            BackColor = (Color)Logview4netSettings.Instance["BaseColor"];
            
            _session = new Session(listenerBase, viewer);
...
#endif
        /// <summary>
        /// Bring us Settings Dlg and allow configuration <see cref="ConfigureSession"/> class.
        /// </summary>
        /// <param name="session">The session.</param>
		/// <param name="theConfigurator">The Configurator Object.</param>
   ...
   //         _viewerConfigurator = theConfigurator;//new textConfigurator((textViewer) _session.Viewer);
        ...
        private void ConfigureSession_Load(object sender, EventArgs e)
        {
			...
			if (_sessionType == SESSION_TYPE.TEXTLOG)
			{
				_actionManager.LoadConfiguration((TextViewer)_viewerConfigurator.Viewer);
