...
namespace logview4net.Viewers
{
	...
	/// </summary>
	public class extLogConfigurator : ConfiguratorBase
	{
		#region My variables

		private ArrayList action = new ArrayList();
		private EXTLogViewer _viewer = null;
		private ILog _log = Logger.GetLogger("logview4net.Viewers.extLogConfigurator");
		...
		/// <summary>
		/// Creates a new <see cref="extLogConfigurator"/> instance.
		/// </summary>
		public extLogConfigurator()
		{
			_viewer = new EXTLogViewer();
		...
		public extLogConfigurator(EXTLogViewer viewer)
		{
			_viewer = viewer;
			PreInitializeComponent();
	...
	//DMOOUT		txtExample.Font = (Font)_viewer.TextFont.Clone();
	...
	//DMOOUT		font.Font = (Font)_viewer.TextFont.Clone();

			font.ShowDialog();
	//DMOOUT		txtExample.Font = (Font)font.Font.Clone();
	//DMOOUT		_viewer.TextFont = (Font)font.Font.Clone();
		}
		...
		/// </summary>
		/// <value></value>
		public override ViewerBase Viewer
		{
			get { return _viewer; }
			set
			{
				_viewer = (EXTLogViewer)value;
