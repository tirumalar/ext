...
**************************************/
    ...
    #define Opamp_1_CTB_CTRL_REG       (*(reg32 *) Opamp_1_cy_psoc4_abuf__CTB_CTB_CTRL)
    #define Opamp_1_CTB_CTRL_PTR       ( (reg32 *) Opamp_1_cy_psoc4_abuf__CTB_CTB_CTRL)
#else
