...
#if !defined(CY_SCB_I2C_I2C_1_H)
#define CY_SCB_I2C_I2C_1_H
...
#define I2C_1_I2C_DATA_RATE              (1000u)
#define I2C_1_I2C_DATA_RATE_ACTUAL       (960u)
...
/* I2C sub mode enum */
#define I2C_1_I2C_MODE_SLAVE              (0x01u)
#define I2C_1_I2C_MODE_MASTER             (0x02u)
#define I2C_1_I2C_MODE_MULTI_MASTER       (0x06u)
#define I2C_1_I2C_MODE_MULTI_MASTER_SLAVE (0x07u)
#define I2C_1_I2C_MODE_MULTI_MASTER_MASK  (0x04u)

#if (I2C_1_SCB_MODE_UNCONFIG_CONST_CFG)

    /* Returns true if slave mode is enabled */
    #define I2C_1_I2C_SLAVE  (0u != (I2C_1_I2C_MODE_SLAVE & I2C_1_mode))

    /* Returns true if master mode is enabled */
    #define I2C_1_I2C_MASTER (0u != (I2C_1_I2C_MODE_MASTER & I2C_1_mode))

    /* Returns true if multi-master mode is enabled */
    #define I2C_1_I2C_MULTI_MASTER \
                            (0u != (I2C_1_I2C_MODE_MULTI_MASTER_MASK & I2C_1_mode))

    /* Returns true if mode is multi-master-slave */
    #define I2C_1_I2C_MULTI_MASTER_SLAVE \
                            (I2C_1_I2C_MODE_MULTI_MASTER_SLAVE == I2C_1_mode)

    /* Returns true if address accepts in RX FIFO */
    #define I2C_1_CHECK_I2C_ACCEPT_ADDRESS   (0u != I2C_1_acceptAddr)
    #define I2C_1_CHECK_I2C_GENERAL_CALL \
                (0u != (I2C_1_I2C_CTRL_REG & I2C_1_I2C_CTRL_S_GENERAL_IGNORE))
    ...
    #define I2C_1_CHECK_I2C_GENERAL_CALL_CONST       (1u)
    #define I2C_1_I2C_CUSTOM_ADDRESS_HANDLER_CONST   (1u)
    ...
    /* Returns true if slave mode is enabled */
    #define I2C_1_I2C_SLAVE   (0u != (I2C_1_I2C_MODE_SLAVE & I2C_1_I2C_MODE))

    /* Returns true if master mode is enabled */
    #define I2C_1_I2C_MASTER  (0u != (I2C_1_I2C_MODE_MASTER & I2C_1_I2C_MODE))

    /* Returns true if multi-master mode is enabled */
    #define I2C_1_I2C_MULTI_MASTER \
                                    (0u != (I2C_1_I2C_MODE_MULTI_MASTER_MASK & I2C_1_I2C_MODE))

    /* Returns true if mode is multi-master-slave */
    #define I2C_1_I2C_MULTI_MASTER_SLAVE \
                                    (I2C_1_I2C_MODE_MULTI_MASTER_SLAVE == I2C_1_I2C_MODE)

    /* Returns true if address accepts in RX FIFO */
    #define I2C_1_CHECK_I2C_ACCEPT_ADDRESS   (0u != I2C_1_I2C_ACCEPT_ADDRESS)
    #define I2C_1_CHECK_I2C_GENERAL_CALL     (0u != I2C_1_I2C_ACCEPT_GENERAL_CALL)

    /* Returns true if wakeup on address match is enabled */
    #define I2C_1_I2C_WAKE_ENABLE_CONST  (0u != I2C_1_I2C_WAKE_ENABLE)
    ...
    #define I2C_1_CHECK_I2C_GENERAL_CALL_CONST   (I2C_1_CHECK_I2C_GENERAL_CALL)
    #define I2C_1_I2C_CUSTOM_ADDRESS_HANDLER_CONST   (I2C_1_CHECK_I2C_ACCEPT_ADDRESS_CONST || \
                                                                  I2C_1_CHECK_I2C_GENERAL_CALL_CONST)
...
#define I2C_1_I2C_CUSTOM_ADDRESS_HANDLER (I2C_1_CHECK_I2C_GENERAL_CALL || \
                                                     I2C_1_CHECK_I2C_ACCEPT_ADDRESS)
...
typedef struct
{
     ...
     *  - I2C_1_I2C_MODE_SLAVE
     *  - I2C_1_I2C_MODE_MASTER
     *  - I2C_1_I2C_MODE_MULTI_MASTER
     *  - I2C_1_I2C_MODE_MULTI_MASTER_SLAVE
    */
    uint32 mode;
...
*/
    ...
    void I2C_1_SetI2cAddressCustomInterruptHandler(uint32 (*func) (void));
...
#define I2C_1_I2C_WRITE_XFER_MODE    (0u)    /* Write    */
#define I2C_1_I2C_READ_XFER_MODE     (1u)    /* Read     */
#define I2C_1_I2C_ACK_ADDR           (0u)    /* Send ACK to address */
#define I2C_1_I2C_NAK_ADDR           (1u)    /* Send NAK to address */
#define I2C_1_I2C_ACK_DATA           (0u)    /* Send ACK to data */
#define I2C_1_I2C_NAK_DATA           (1u)    /* Send NAK to data */
...
/* Master status */
#define I2C_1_I2C_MSTAT_CLEAR            ((uint16) 0x00u)   /* Clear (init) status value */

#define I2C_1_I2C_MSTAT_RD_CMPLT         ((uint16) 0x01u)   /* Read complete               */
#define I2C_1_I2C_MSTAT_WR_CMPLT         ((uint16) 0x02u)   /* Write complete              */
#define I2C_1_I2C_MSTAT_XFER_INP         ((uint16) 0x04u)   /* Master transfer in progress */
#define I2C_1_I2C_MSTAT_XFER_HALT        ((uint16) 0x08u)   /* Transfer is halted          */

#define I2C_1_I2C_MSTAT_ERR_MASK         ((uint16) 0x3F0u) /* Mask for all errors                          */
#define I2C_1_I2C_MSTAT_ERR_SHORT_XFER   ((uint16) 0x10u)  /* Master NAKed before end of packet            */
#define I2C_1_I2C_MSTAT_ERR_ADDR_NAK     ((uint16) 0x20u)  /* Slave did not ACK                            */
#define I2C_1_I2C_MSTAT_ERR_ARB_LOST     ((uint16) 0x40u)  /* Master lost arbitration during communication */
#define I2C_1_I2C_MSTAT_ERR_ABORT_XFER   ((uint16) 0x80u)  /* The Slave was addressed before the Start gen */
#define I2C_1_I2C_MSTAT_ERR_BUS_ERROR    ((uint16) 0x100u) /* The misplaced Start or Stop was occurred     */
#define I2C_1_I2C_MSTAT_ERR_XFER         ((uint16) 0x200u) /* Error during transfer                        */
...
#define I2C_1_I2C_MSTR_ERR_TIMEOUT       (I2C_1_I2C_MASTER_TIMEOUT) /* Operation timeout        */
...
#define I2C_1_I2C_TX_OVERFLOW_COUNT      (I2C_1_I2C_FIFO_SIZE + 2u)
...
#if(I2C_1_SCB_MODE_UNCONFIG_CONST_CFG)
    extern const I2C_1_I2C_INIT_STRUCT I2C_1_configI2C;
#endif /* (I2C_1_SCB_MODE_UNCONFIG_CONST_CFG) */
...
#define I2C_1_I2C_FSM_EXIT_IDLE      (0x00u) /* Master and Slave are not active, need to exit to IDLE */
...
#define I2C_1_I2C_FSM_MSTR_ADDR      (0x08u) /* Master address phase           */
#define I2C_1_I2C_FSM_MSTR_DATA      (0x04u) /* Master data phase              */
#define I2C_1_I2C_FSM_MSTR_RD        (0x01u) /* Master read phase              */

#define I2C_1_I2C_FSM_MSTR_WR_ADDR   (0x28u) /* FSM master transmit address with write          */
#define I2C_1_I2C_FSM_MSTR_RD_ADDR   (0x29u) /* FSM master transmit address with read           */
#define I2C_1_I2C_FSM_MSTR_WR_DATA   (0x24u) /* FSM master writes data into the slave           */
...
#define I2C_1_CHECK_I2C_FSM_MASTER   (0u != (I2C_1_I2C_FSM_MASTER & I2C_1_state))

/* Returns true if FSM is in any Slave state */
#define I2C_1_CHECK_I2C_FSM_SLAVE    (0u != (I2C_1_I2C_FSM_SLAVE  & I2C_1_state))

/* Returns true if FSM is in Master send address state */
#define I2C_1_CHECK_I2C_FSM_ADDR (0u != (I2C_1_I2C_FSM_MSTR_ADDR & I2C_1_state))
...
#define I2C_1_CHECK_I2C_FSM_HALT (I2C_1_I2C_FSM_MSTR_HALT == I2C_1_state)

/* Set Master read or write completion depends on state */
#define I2C_1_GET_I2C_MSTAT_CMPLT (I2C_1_CHECK_I2C_FSM_RD ?           \
                                                    (I2C_1_I2C_MSTAT_RD_CMPLT) : \
                                                    (I2C_1_I2C_MSTAT_WR_CMPLT))
...
#define I2C_1_I2C_MASTER_TIMEOUT_POS (31u)
#define I2C_1_I2C_MASTER_TIMEOUT     ((uint32) 0x01u << I2C_1_I2C_MASTER_TIMEOUT_POS)

/* Slave address match or general call */
#define I2C_1_SLAVE_INTR_I2C_ADDR    (I2C_1_INTR_SLAVE_I2C_ADDR_MATCH | \
                                                 I2C_1_INTR_SLAVE_I2C_GENERAL)

/* Send byte condition: used by */
#define I2C_1_INTR_MASTER_SEND_BYTE   (I2C_1_INTR_MASTER_I2C_ACK      | \
                                                  I2C_1_INTR_MASTER_I2C_NACK     | \
                                                  I2C_1_INTR_MASTER_I2C_ARB_LOST | \
                                                  I2C_1_INTR_MASTER_I2C_BUS_ERROR)
/* Receive byte error conditions */
#define I2C_1_INTR_MASTER_RECEIVE_BYTE   (I2C_1_INTR_MASTER_I2C_ARB_LOST | \
                                                     I2C_1_INTR_MASTER_I2C_BUS_ERROR)
/* Stop condition */
#define I2C_1_INTR_MASTER_SEND_STOP  (I2C_1_INTR_MASTER_I2C_STOP     | \
                                                 I2C_1_INTR_MASTER_I2C_ARB_LOST | \
                                                 I2C_1_INTR_MASTER_I2C_BUS_ERROR)
...
#define I2C_1_CTRL_I2C       (I2C_1_CTRL_MODE_I2C)

#define I2C_1_I2C_CTRL       (I2C_1_I2C_CTRL_S_GENERAL_IGNORE)

#define I2C_1_I2C_RX_CTRL    ((I2C_1_ONE_BYTE_WIDTH - 1u) | \
                                          I2C_1_RX_CTRL_MSB_FIRST    | \
                                          I2C_1_RX_CTRL_ENABLED)

#define I2C_1_I2C_TX_CTRL    ((I2C_1_ONE_BYTE_WIDTH - 1u) | \
                                         I2C_1_TX_CTRL_MSB_FIRST     | \
                                         I2C_1_TX_CTRL_ENABLED)

#define I2C_1_I2C_INTR_SLAVE_MASK    (I2C_1_INTR_SLAVE_I2C_ADDR_MATCH | \
                                                 I2C_1_INTR_SLAVE_I2C_NACK       | \
                                                 I2C_1_INTR_SLAVE_I2C_WRITE_STOP | \
                                                 I2C_1_INTR_SLAVE_I2C_BUS_ERROR  | \
                                                 I2C_1_INTR_SLAVE_I2C_ARB_LOST)

#define I2C_1_I2C_INTR_MASTER_MASK   (I2C_1_INTR_MASTER_I2C_ARB_LOST | \
                                                 I2C_1_INTR_MASTER_I2C_NACK     | \
                                                 I2C_1_INTR_MASTER_I2C_STOP     | \
                                                 I2C_1_INTR_MASTER_I2C_BUS_ERROR)

/* Calculates tLOW in uS units */
#define I2C_1_I2C_TLOW_TIME  ((1000u / I2C_1_I2C_DATA_RATE) + \
                                            ((0u != (1000u % I2C_1_I2C_DATA_RATE)) ? (1u) : (0u)))
/* tHIGH = tLOW */
#define I2C_1_I2C_THIGH_TIME (I2C_1_I2C_TLOW_TIME)

#define I2C_1_I2C_SCL_LOW    (0u)
#define I2C_1_I2C_SCL_HIGH   (1u)

/* Timeout in us for tLOW and tHIGH generation (equal to 20ms) */
#define I2C_1_I2C_PHASE_GEN_TIMEOUT      (20000u)

#define I2C_1_I2C_IGNORE_GENERAL_CALL    ((uint32) (0u == I2C_1_I2C_ACCEPT_GENERAL_CALL))

/* Convert the timeout in milliseconds to microseconds */
#define I2C_1_I2C_CONVERT_TIMEOUT_TO_US(timeoutMs)   ((timeoutMs) * 1000u)
...
***************************************/
    ...
    #define I2C_1_I2C_DEFAULT_I2C_CTRL \
                    (I2C_1_GET_I2C_CTRL_HIGH_PHASE_OVS(I2C_1_I2C_OVS_FACTOR_HIGH_MIN)   | \
                     ...
                     I2C_1_GET_I2C_CTRL_S_GENERAL_IGNORE(I2C_1_I2C_IGNORE_GENERAL_CALL) | \
    ...
    #define I2C_1_I2C_DEFAULT_RX_FIFO_CTRL (0u)
    #define I2C_1_I2C_DEFAULT_TX_FIFO_CTRL (0u)

    /* Interrupt sources */
    #define I2C_1_I2C_DEFAULT_INTR_I2C_EC_MASK   (I2C_1_NO_INTR_SOURCES)
    #define I2C_1_I2C_DEFAULT_INTR_SPI_EC_MASK   (I2C_1_NO_INTR_SOURCES)
    #define I2C_1_I2C_DEFAULT_INTR_RX_MASK       (I2C_1_NO_INTR_SOURCES)
    #define I2C_1_I2C_DEFAULT_INTR_TX_MASK       (I2C_1_NO_INTR_SOURCES)

    #define I2C_1_I2C_DEFAULT_INTR_SLAVE_MASK    ((I2C_1_I2C_SLAVE) ? \
                (I2C_1_I2C_INTR_SLAVE_MASK | \
                 I2C_1_GET_INTR_SLAVE_I2C_GENERAL(I2C_1_I2C_ACCEPT_GENERAL_CALL)) : (0u))

    #define I2C_1_I2C_DEFAULT_INTR_MASTER_MASK   (I2C_1_NO_INTR_SOURCES)

#endif /* (I2C_1_SCB_MODE_I2C_CONST_CFG) */

#endif /* (CY_SCB_I2C_I2C_1_H) */
