...
static uint8 I2C_1_slReadBuf[I2C_1_I2C_BTLDR_SIZEOF_READ_BUFFER];

/* Reads from this buffer */
static uint8 I2C_1_slWriteBuf[I2C_1_I2C_BTLDR_SIZEOF_WRITE_BUFFER];

/* Flag to release buffer to be read */
static uint32 I2C_1_applyBuffer;
...
static void I2C_1_I2CResposeInsert(void);


/*******************************************************************************
* Function Name: I2C_1_I2CCyBtldrCommStart
****************************************************************************//**
*
...
*
* \globalvars
*  I2C_1_applyBuffer - the flag to release the buffer with a response
*  to be read by the host.
*
*******************************************************************************/
void I2C_1_I2CCyBtldrCommStart(void)
{
    I2C_1_I2CSlaveInitWriteBuf(I2C_1_slWriteBuf, I2C_1_I2C_BTLDR_SIZEOF_WRITE_BUFFER);
    I2C_1_I2CSlaveInitReadBuf (I2C_1_slReadBuf, 0u);

    I2C_1_SetCustomInterruptHandler(&I2C_1_I2CResposeInsert);
...
/*******************************************************************************
* Function Name: I2C_1_I2CCyBtldrCommStop
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: I2C_1_I2CCyBtldrCommReset
****************************************************************************//**
*
...
*
* \globalvars
*  I2C_1_slRdBufSize - used to store slave read buffer size.
*  I2C_1_slRdBufIndex - used to store the current index within the
*  slave read buffer.
...
/*******************************************************************************
* Function Name: I2C_1_I2CCyBtldrCommRead
****************************************************************************//**
*
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        while (0u != timeoutMs)
        {
            ...
            if (0u != (I2C_1_I2C_SSTAT_WR_CMPLT & I2C_1_slStatus))
            {
                ...
                *count = (uint16) I2C_1_slWrBufIndex;
                ...
                (void) memcpy((void *) pData, (const void *) I2C_1_slWriteBuf,
                                              I2C_1_BYTES_TO_COPY(*count, size));
...
/*******************************************************************************
* Function Name: I2C_1_I2CCyBtldrCommWrite
****************************************************************************//**
*
...
*
* \globalvars
*  I2C_1_applyBuffer - the flag to release the buffer with
*  to be read by the host.
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: I2C_1_I2CResposeInsert
****************************************************************************//**
*
...
static void I2C_1_I2CResposeInsert(void)
{
    if (I2C_1_CHECK_INTR_SLAVE_MASKED(I2C_1_INTR_SLAVE_I2C_ADDR_MATCH))
    {
        ...
        else
        {
            ...
            {
                I2C_1_slRdBufIndex = I2C_1_slRdBufSize;
            }
        }
    }
}
