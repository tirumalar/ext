...
void IDAC_2_Init(void)
{
    ...
    #if(IDAC_2_MODE_SOURCE == IDAC_2_IDAC_POLARITY)
        regVal  = IDAC_2_CSD_TRIM1_REG & ~(IDAC_2_CSD_IDAC_TRIM1_MASK);
        regVal |=  (IDAC_2_SFLASH_TRIM1_REG & IDAC_2_CSD_IDAC_TRIM1_MASK);
        IDAC_2_CSD_TRIM1_REG = regVal;
    #else
        regVal  = IDAC_2_CSD_TRIM2_REG & ~(IDAC_2_CSD_IDAC_TRIM2_MASK);
        regVal |=  (IDAC_2_SFLASH_TRIM2_REG & IDAC_2_CSD_IDAC_TRIM2_MASK);
        IDAC_2_CSD_TRIM2_REG = regVal;
    #endif /* (IDAC_2_MODE_SOURCE == IDAC_2_IDAC_POLARITY) */
