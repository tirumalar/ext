...
module top ;
	...
	wire [0:0] tmpOE__CAM_INT_net;
	wire [0:0] tmpFB_0__CAM_INT_net;
	wire [0:0] tmpIO_0__CAM_INT_net;
	wire [0:0] tmpINTERRUPT_0__CAM_INT_net;
	electrical [0:0] tmpSIOVREF__CAM_INT_net;

	cy_psoc3_pins_v1_10
		#(.id("5df1f336-0038-42e5-a04d-e6b3167da595"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		CAM_INT
		 (.oe(tmpOE__CAM_INT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CAM_INT_net[0:0]}),
		  .io({tmpIO_0__CAM_INT_net[0:0]}),
		  .siovref(tmpSIOVREF__CAM_INT_net),
		  .interrupt({tmpINTERRUPT_0__CAM_INT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CAM_INT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
