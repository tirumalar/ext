...
$(MEM_0)_START := 0x05000000
$(MEM_0)_END := 0x0503bfff
$(MEM_0)_SPAN := 0x0003c000
...
$(HDL_SIM_DIR)/$(MEM_0).dat: $(MEM_0).flash
	...
	$(FLASH2DAT) --infile=$< --outfile=$@ \
		--base=0x0 --end=0x3bfff --width=$(mem_width) \
