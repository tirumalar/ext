...
echo "Building ${i}/${configuration}"
	"${ECLIPSE_CDT}/eclipse" -Xms1024m -Xmx4096m --launcher.suppressErrors -data "${EYELOCK_WS_EXT}" -nosplash -application  org.eclipse.cdt.managedbuilder.core.headlessbuild -cleanBuild "${i}/${configuration}"
done
