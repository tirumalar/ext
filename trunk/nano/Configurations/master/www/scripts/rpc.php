...
**/
	...
	//	PostProcessSettingsChange(); // Kills the eyelock app
	 ...
	 //  NXTW_shell_exec("206");
        ...
        case 'updatetime':
        {
			...
			$strServer = escapeshellarg($_REQUEST['timeserver']);
	...
	//        error_log("result of local time sync attempt >".$strDate);
            // set the hardware clock
            $strResult = NXTW_shell_exec("46");//"/sbin/hwclock -w"); // Does no harm to call this even on failure...
